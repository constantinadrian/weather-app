...
import ModelFallback from "../components/UI/ModelFallback";

const ModelComponent = lazy(() => import("../components/UI/Model"));
        ...
        <>
            <div className={`${classes["full-screen"]}`}>
                ...
                >
                    ...
                    <div
                        className={`${classes["welcome-text"]} position-absolute`}
                    >
                        <h1>AC Weather</h1>
                        <Link
